...
public class AESUtil {
	...
	public static void main(String[] args) throws UnsupportedEncodingException {
		System.out.println(decrypt("mHBFjdFQSFhL+DgUVO0ZKQ==",	 KEY));
		System.out.println("RPC_ALLOWIP="+AESUtil.encrypt("172.31.214.79", KEY));
		System.out.println("RPC_PORT="+AESUtil.encrypt("62355", KEY));
		System.out.println("RPC_USER="+AESUtil.encrypt("udbsper", KEY));
		System.out.println("RPC_PASSWORD="+AESUtil.encrypt("c2XcYjWd8ZuAu1pb", KEY));
